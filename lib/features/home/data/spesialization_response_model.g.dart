...
part of 'spesialization_response_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

SpesializationResponseModel _$SpesializationResponseModelFromJson(
        Map<String, dynamic> json) =>
    SpesializationResponseModel(
      specializationDataList: (json['data'] as List<dynamic>?)
          ?.map((e) => SpecializationData.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$SpesializationResponseModelToJson(
        SpesializationResponseModel instance) =>
    <String, dynamic>{
