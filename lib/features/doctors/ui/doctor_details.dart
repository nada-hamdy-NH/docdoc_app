...
class DoctorDetailsScreen extends StatefulWidget {
  ...
  const DoctorDetailsScreen(
      {super.key, required this.doctor, required this.image});
  ...
  Widget build(BuildContext context) {
    return SafeArea(
        child: Scaffold(
            body: Padding(
                padding:
                    EdgeInsets.symmetric(vertical: 32.0.h, horizontal: 20.w),
                child: Column(
                    ...
                    children: [
                      ...
                      verticalSpace(32),
                      CustomDoctorContainer(widget: widget),
                      verticalSpace(32),
                      // Tabs
                      Row(
