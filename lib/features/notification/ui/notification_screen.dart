...
class NotificationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<Widget>items = [
      ...
      NotificationItem(
        ...
        child: Text("Yasterday",style: TextStyles.font12LiteGray500Weight,),
      ) ,
      NotificationItem(
  ...
  Widget NotificationItem({required String icon ,required Color color ,required bool isRead}){
    return  Container(
                          height: 121.h,
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                CircleAvatar(
                                  radius: 2.5.r,
                                 backgroundColor: isRead ?   Colors.white  : ColorsManager.liteRed,
                                  ),
